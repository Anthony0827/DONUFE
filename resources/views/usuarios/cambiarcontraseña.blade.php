                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); margin: 20px; padding: 20px;">
                    <tr>
                        <td align="center" style="padding: 10px 20px;">
                            ...
                            <p style="color: #555555; font-size: 16px; margin: 0; margin-bottom: 5px;">Hola <strong>Usuario</strong>,</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 20px;">
                            ...
                            <div style="text-align: center; margin: 20px 0;">
                                <a href="{{ route('usuarios.password.reset', $token) }}" 
                            ...
                            <p style="color: #007BFF; font-size: 14px; word-break: break-word; text-align: center; margin: 0; margin-bottom: 10px;">
                                <a href="{{ route('usuarios.password.reset', $token) }}" target="_blank" style="color: #007BFF; text-decoration: none;">
                                    {{ route('usuarios.password.reset', $token) }}
                                </a>
                            </p>
                        </td>
                    </tr>
