			...
			<div class="space-y-4">
				...
				<div class="space-y-3">
                    ...
                    <div class="space-y-3">
                        ...
                        <p class="text-start">Para ello, te pediremos que realices 4 análisis: <span class="font-semibold">Cultural</span> - <span class="font-semibold">Felicidad Laboral</span> - <span class="font-semibold">Factores Sociales</span> y <span class="font-semibold">Burnout</span>.</p>
                ...
                <!-- Botón Continuar -->
<button id="btnContinuar" class="w-full md:w-auto mb-1 px-7 py-2.5 rounded-lg bg-kulture-green text-white shadow-md shadow-green-400 hover:bg-green-100 hover:text-kulture-green hover:shadow-none">Continuar <i class="bi bi-arrow-right-short"></i></button>
